...
--- GUI
    ...
    function GUI()
        ...
        --Begin
        local visible, open = reaper.ImGui_Begin(ctx, 'Pitch Class Counter', true,    reaper.ImGui_WindowFlags_None()
        ...
        if  visible then
            ...
            local cor = reaper.ImGui_ColorConvertHSVtoRGB( 0.51, 1, 0.61, 1)
