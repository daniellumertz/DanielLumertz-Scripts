...
ToolTips = {
    ...
    actions = {
        ...
        deletepos = 'Delete any generated item that is inside a cloud items region.\nHold ctrl to apply to all cloud items.',
        delete = 'Delete any generated item from a cloud items.\nHold ctrl to apply to all cloud items.',
        deleteall = 'Delete all generated items, even if the cloud item is no longer in the project.'
    },
