...
---@return  boolean is_recordFX is this FX at Record Input FX.
function DL.fx.GetLastFXTrackItem(tracknumber, fxnumber)
    local tracknumber_bit = DL.num.bit.ToBitString(tracknumber,true)
    ...
    --- Fx Number
    local fxnumber_bit = DL.num.bit.ToBitString(fxnumber,true)
    -- take
    local take_idx
