function CreateMap()
    ...
    defaultab.pref_keep_cuts = 1 -- Mode to keep items modfications 
...
function UpdateMenuConfig(y)
    local options = {'delete_outside_track' ,'auto_delete_odd' , 'auto_delete_odds_project'}
    local menu_num = {2                     ,4                 ,5                          }
    for i = 1, #options do
